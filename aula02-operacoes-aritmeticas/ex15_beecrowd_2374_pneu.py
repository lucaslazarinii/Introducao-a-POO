...
A maioria das bombas atuais são eletrônicas, permitindo que o motorista indique
a pressão desejada num teclado. Ao ser ligada ao pneu, a bomba primeiro lê a
pressão atual e calcula a diferença de pressão entre a desejada e a lida.
...
e a pressão do pneu lida pela bomba, indica a diferença entre a pressão
desejada e a pressão lida."""


d = int(input("Digite a pressão desejada: "))
l = int(input("Digite a pressão lida pela bomba: "))

t = (d-l)

print("Diferença: {}".format(t))
